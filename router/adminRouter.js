...
adminRoute.post('/editcategory',auth.isLogin,catcontroller.editcategory)
adminRoute.delete('/deletecategory/:id',auth.isLogin,catcontroller.deletecategory)
adminRoute.post('/list',catcontroller.list)
adminRoute.post('/unlist',catcontroller.unlist)
...
adminRoute.post('/listproduct',procontroller.listProduct)
adminRoute.post('/unlistproduct',procontroller.unlistProduct)
...
adminRoute.post('/updatestatus',auth.isLogin,admincontroller.updateorder)
